  ...
  "rounded-xl border bg-card text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        feature: "border-0 bg-gradient-to-b from-card to-secondary/30 shadow-lg",
        quiz: "border-2 hover:border-primary shadow-sm hover:shadow-md",
        flipcard: "preserve-3d cursor-pointer",
      },
    },
    defaultVariants: {
      variant: "default",
